 ...
 *       &lt;sequence>
 *         &lt;element name="employees" type="{http://annotation/}emp" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "dept", propOrder = { "employees", "id", "location", "name" })
public class Dept {

    @XmlElement(nillable = true)
    protected List<Emp> employees;
    protected int id;
